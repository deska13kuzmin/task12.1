...
public class Tests {
    void testNull() {
        assertEquals(NullPointerException.class, Integer.decode(null));
    }
    ...
    void testFormatExceptionOnWrongSignCharPosition() {
        assertThrows(NumberFormatException.class, () -> Integer.decode("1-111"));
    }
    ...
    void testSignedHexadecimalNumber() { 
	assertEquals(Integer.valueOf(-276), Integer.decode("-0x114")); 
    }
	...
	assertThrows(NumberFormatException.class, () -> Integer.decode("stroka"));
    }
